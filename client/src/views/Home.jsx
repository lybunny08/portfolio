...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#ebebeb] flex flex-col px-10 pt-10">
  ...
  <span className="text-lg font-semibold">Portfolio.</span>
      ...
      <div className='flex flex-row items-center justify-between space-x-60 mb-8'>
      ...
      <div className="flex flex-row justify-between items-center w-full px-28">
        {/* coin gauche */}
        ...
        <div className='flex flex-col items-center'>
          ...
          <div className="flex flex-col items-center">
            <span className='text-[12px] text-center'>PASSIONATE ABOUT CREATING</span>
            <span className='text-[12px] text-center'>WEB AND MOBILE APPLICATION, BUT I LIKE</span>
