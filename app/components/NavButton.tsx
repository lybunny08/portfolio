...
export default function NavButton() {
  return (
    <div className='flex flex-row text-[#cacaca] '>
			<button className="group bg-[#070707] cursor-pointer px-[8px] md:px-[16px] py-[8px] flex items-center justify-center rounded-full uppercase text-[12px] leading-[12px] md:text-[14px] border border-[#cacaca]">
